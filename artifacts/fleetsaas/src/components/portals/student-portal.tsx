  ...
  return (
    <div className="w-full px-4 pb-8 pt-4 flex flex-col gap-5">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2.5 rounded-xl border border-green-600/40 bg-green-950/20 py-3.5 transition-all hover:bg-green-950/40 active:scale-[0.98]"
      >
        <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0 fill-green-400" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="text-sm font-semibold text-green-400">Contact Support</span>
      </a>
    </div>
  );
}
