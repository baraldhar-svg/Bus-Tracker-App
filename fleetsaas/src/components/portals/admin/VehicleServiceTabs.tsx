...
export default function VehicleServiceTabs({
  vehicles,
  tenantHeaders,
  apiPost,
  apiDelete,
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <input
                ...
                className="border rounded-lg p-2 className='w-full'"
              />
            </div>
            <button
            ...
            <div className="max-h-40 overflow-y-auto border rounded-xl divide-y text-xs mt-2">
              {fuelRows.map((r) => (
                <div
                  key={r.id}
        ...
        {!loading && subTab === "service" && (
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <input
                placeholder="Part Type (e.g. Tires, Brakes)"
              ...
              {maintRows.map((r) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      {r.serviceDate} · Cost: Rs {r.costNpr}
                    </p>
                  </div>
                  <button
                    onClick={() => {
                      if (confirm("Delete?")) {
                        void apiDelete(`/maintenance-records/${r.id}`);
                        void loadAllData();
                      }
                    }}
                    className="text-red-500"
        ...
        {!loading && subTab === "docs" && (
          <div className="space-y-3 text-xs">
            <p className="text-[11px] text-muted-foreground font-semibold uppercase tracking-wider">
              Bluebook & Insurance Expiry Logs
            </p>
